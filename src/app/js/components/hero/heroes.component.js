System.register(['@angular/core', '@angular/router-deprecated', '../../services/hero.service', './hero-detail.component'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            HeroesComponent = (function () {
                ...
                HeroesComponent = __decorate([
                    core_1.Component({
                        selector: 'my-heroes',
                        templateUrl: 'components/hero/heroes.component.html',
                        styleUrls: ['components/hero/heroes.component.css'],
